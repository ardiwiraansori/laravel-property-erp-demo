<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="block_name" class="form-control" value="{{ old('block_name', $unit->block_name) }}">
        @error('block_name')
            <p class="text-danger text-xs mt-1">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="number" name="land_area" class="form-control" value="{{ old('land_area', $unit->land_area) }}">
        @error('land_area')
            <p class="text-danger text-xs mt-1">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="number" name="bedrooms" class="form-control" value="{{ old('bedrooms', $unit->bedrooms ?? 2) }}">
        @error('bedrooms')
            <p class="text-danger text-xs mt-1">{{ $message }}</p>
        @enderror
    </div>
